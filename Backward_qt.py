import sys
import gc
from Backward_Window import Ui_MainWindow
...
import datetime
import collections
from learning.mnist.model.all_methods import neural_test
...
# 定义槽函数
    def backward_calculate(self):
        ...
        reply = QMessageBox.information(self, "提示", "反向计算完成,用时"+timeStr, QMessageBox.Yes | QMessageBox.No)
